...
namespace Commander
{
    ...
    public class CommandObj
    {
        ...
        public CommandObj(object cog, MethodInfo methodInfo, bool invokable, string name, string description,
            string[] examples) : this(cog, null, methodInfo, invokable, name, description, examples)
        {
        }
        ...
        public static string CallString(CommandObj cmd)
        {
            ...
            var callstring = "";
            var name = "";
            while (names.TryPop(out name)) callstring += name + " ";
        ...
        public string Usage(Program program)
        {
            ...
            foreach (var entry in parameterInfos)
            {
                ...
                if (param.HasDefaultValue)
                {
                    ...
                    if (param.ParameterType == typeof(string)) usage.Append('"');

                    usage.Append(param.DefaultValue);
